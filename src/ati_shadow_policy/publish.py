...
def build_series_metadata_catalog() -> pd.DataFrame:
    rows = [
        ...
        {
            "dataset": "pricing_regression_summary",
            "series_id": "pricing_regression_summary",
            "frequency": "artifact",
            "value_units": "regression rows",
            "sign_convention": "Regression rows report one coefficient estimate per model, outcome, and term in the locked headline summary pack.",
            "source_quality": "derived_pricing_reduced_form",
            "series_role": "supporting",
            "public_role": "supporting",
        },
        {
            "dataset": "pricing_regression_robustness",
            "series_id": "pricing_regression_robustness",
            "frequency": "artifact",
            "value_units": "regression rows",
            "sign_convention": "Regression rows report primary-predictor checks from the published pricing robustness families.",
            "source_quality": "derived_pricing_reduced_form",
            "series_role": "supporting",
            "public_role": "supporting",
        },
...
def build_dataset_status_table() -> pd.DataFrame:
    ...
    rows = [
        ...
        },
        {
            ...
            "headline_ready": False,
            "fallback_only": True,
            "missing_critical_fields": "pricing_regression_summary_missing" if pricing_regression_summary.empty else "",
            "last_regenerated_utc": _artifact_mtime(TABLES_DIR / "pricing_regression_summary.csv"),
            "review_maturity": "provisional_supporting" if not pricing_regression_summary.empty else "not_started",
            "public_role": "supporting",
        },
        {
            "dataset": "pricing_regression_robustness",
            "readiness_tier": "supporting_provisional" if not pricing_regression_robustness.empty else "not_started",
            "source_quality": "derived_pricing_reduced_form",
            "headline_ready": False,
            "fallback_only": True,
            "missing_critical_fields": "pricing_regression_robustness_missing" if pricing_regression_robustness.empty else "",
            "last_regenerated_utc": _artifact_mtime(TABLES_DIR / "pricing_regression_robustness.csv"),
            "review_maturity": "provisional_supporting" if not pricing_regression_robustness.empty else "not_started",
            "public_role": "supporting",
        },
        {
            "dataset": "pricing_subsample_grid",
